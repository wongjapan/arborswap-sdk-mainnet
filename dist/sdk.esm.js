...
var FACTORY_ADDRESS_MAP = (_FACTORY_ADDRESS_MAP = {}, _FACTORY_ADDRESS_MAP[ChainId.MAINNET] = FACTORY_ADDRESS, _FACTORY_ADDRESS_MAP[ChainId.BSC] = FACTORY_ADDRESS, _FACTORY_ADDRESS_MAP[ChainId.BSC_TESTNET] = FACTORY_ADDRESS, _FACTORY_ADDRESS_MAP[ChainId.ROBURNA] = FACTORY_ADDRESS_ROBURNA, _FACTORY_ADDRESS_MAP[ChainId.ROBURNA_TESTNET] = FACTORY_ADDRESS_ROBURNA_TESTNET, _FACTORY_ADDRESS_MAP);
var EXTERNAL_FACTORY_ADDRESS_MAP = (_EXTERNAL_FACTORY_ADD = {}, _EXTERNAL_FACTORY_ADD[ChainId.MAINNET] = FACTORY_ADDRESS_EXTERNAL, _EXTERNAL_FACTORY_ADD[ChainId.BSC] = FACTORY_ADDRESS_EXTERNAL, _EXTERNAL_FACTORY_ADD[ChainId.BSC_TESTNET] = FACTORY_ADDRESS_EXTERNAL, _EXTERNAL_FACTORY_ADD[ChainId.ROBURNA] = FACTORY_ADDRESS_EXTERNAL, _EXTERNAL_FACTORY_ADD[ChainId.ROBURNA_TESTNET] = FACTORY_ADDRESS_EXTERNAL, _EXTERNAL_FACTORY_ADD);
...
var INIT_CODE_HASH_MAP = (_INIT_CODE_HASH_MAP = {}, _INIT_CODE_HASH_MAP[ChainId.MAINNET] = INIT_CODE_HASH, _INIT_CODE_HASH_MAP[ChainId.BSC] = INIT_CODE_HASH, _INIT_CODE_HASH_MAP[ChainId.BSC_TESTNET] = INIT_CODE_HASH, _INIT_CODE_HASH_MAP[ChainId.ROBURNA] = INIT_CODE_HASH_ROBURNA, _INIT_CODE_HASH_MAP[ChainId.ROBURNA_TESTNET] = INIT_CODE_HASH_ROBURNA_TESTNET, _INIT_CODE_HASH_MAP);
var EXTERNAL_CODE_HASH_MAP = (_EXTERNAL_CODE_HASH_M = {}, _EXTERNAL_CODE_HASH_M[ChainId.MAINNET] = INIT_CODE_HASH_EXTERNAL, _EXTERNAL_CODE_HASH_M[ChainId.BSC] = INIT_CODE_HASH_EXTERNAL, _EXTERNAL_CODE_HASH_M[ChainId.BSC_TESTNET] = INIT_CODE_HASH_EXTERNAL, _EXTERNAL_CODE_HASH_M[ChainId.ROBURNA] = INIT_CODE_HASH_EXTERNAL, _EXTERNAL_CODE_HASH_M[ChainId.ROBURNA_TESTNET] = INIT_CODE_HASH_EXTERNAL, _EXTERNAL_CODE_HASH_M);
...
Currency.NATIVE = (_Currency$NATIVE = {}, _Currency$NATIVE[ChainId.MAINNET] = Currency.ETHER, _Currency$NATIVE[ChainId.BSC] = Currency.BNB, _Currency$NATIVE[ChainId.BSC_TESTNET] = Currency.BNB, _Currency$NATIVE[ChainId.ROBURNA] = Currency.RBA, _Currency$NATIVE[ChainId.ROBURNA_TESTNET] = Currency.RBA, _Currency$NATIVE);
